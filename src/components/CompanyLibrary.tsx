...
export function CompanyLibrary({ workspaceScope, canManage, currentUserId, companyName, onToast }: { workspaceScope?: string; canManage: boolean; currentUserId: string; companyName: string; onToast: (message: string) => void }) {
