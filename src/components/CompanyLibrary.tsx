...
import { Bot, CheckCircle2, Cloud, Database, Download, FileArchive, FileText, FolderSearch, FolderUp, HardDrive, Layers, LockKeyhole, Pencil, Plus, Search, Server, Sparkles, Trash2, Upload, Users, X } from 'lucide-react'
