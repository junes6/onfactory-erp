...
export const CONSENT_TERMS_VERSION = '2026-08-22.1'

export const CONSENT_ITEMS = Object.freeze([
  {
    id: 'dataAccess',
    title: '운영사의 데이터 접근·활용 범위',
    summary: '온팩토리 운영사는 장애 대응·지원·서비스 개선을 위해 귀사 워크스페이스에 운영자 모드로 접속할 수 있으며, 모든 접속·조회·변경은 감사 기록으로 남아 귀사 관리자에게 공개됩니다.',
  ...
  },
  {
    ...
    title: '개인정보 처리위탁',
    summary: '귀사가 등록한 구성원·거래처의 개인정보는 서비스 제공 목적 범위에서 온팩토리가 위탁 처리하며, 위탁 범위·보관 기간·파기 절차는 약관을 따릅니다.',
  ...
  },
  {
    ...
    body: '[placeholder] AI 처리 고지 — 처리 목적: 문서 분류 제안, 업무 생성 제안, 성과 요약, 안전 점검 제안. 처리 주체: 온팩토리 및 연동 AI 제공자. 거부권: 고객사 관리자는 AI 기능을 비활성화할 수 있다. … (정식 문서로 교체 예정)',
  },
])
